...
const { myAccount, addAddress, getAddress, dafaultAddress, deleteAddress, getEditAddress, updateAddress, mobileChange, cofirmotp, updateProfile, passwordUpdate } = require('../controller/profileControllers')
const { login, signup, home, otppage, singleProduct, checkout, product, allProduct, success, loginPost, doSignup, otppageverify, OTPResend, logout, productFilter, verification, forgetPassword, forgetemail, changePassword, otpForget, review } = require('../controller/userControllers')
